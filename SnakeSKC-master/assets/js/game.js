...
(function (Game) {
    ...
    //How many apples have to be eaten until the game speed ups once
    let apples_speed_up = 5
    let apples_until_speed_up = apples_speed_up
    ...
    // When the snake reaches a horizontal or vertical edge, it resets the game.
    ...
    function eatApple() {
        ...
        //Increase the player's score with the amount offered by the apple
        score = score + apple.score ;

        //BONUS_TASK increase the speed of the game every x appels
        apples_until_speed_up--;
        if (apples_until_speed_up == 0) {
            apples_until_speed_up = apples_speed_up
